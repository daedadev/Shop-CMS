  ...
  return (
    <>
      <button
        ...
        className="md:hidden sticky flex bottom-0 left-0 z-50 bg-slate-800 text-white p-3 rounded-tr-xl w-16 h-16 items-center justify-center"
      >
      ...
      <section
        className={
          showNavigation
            ? "absolute md:hidden flex-col bottom-0 left-0 bg-slate-800 w-16 h-2/3 z-40 mb-10 items-center justify-center rounded-tr-lg duration-500"
            : "absolute md:hidden flex-col bottom-0 left-0 w-0 bg-slate-800 h-2/3  z-40 mb-10 items-center justify-center rounded-tr-lg duration-500"
        }
      >
        <section
          className={
